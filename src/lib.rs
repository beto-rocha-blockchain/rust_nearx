pub mod calc_with_1 {
    ...
    /// 
    /// assert_eq!(42, calc_near_x::calc_with_1::sum_plus_one(41, 0));
    /// assert_eq!(4, calc_near_x::calc_with_1::sum_plus_one(1, 2));
    /// assert_eq!(1, calc_near_x::calc_with_1::sum_plus_one(0, 0));
    /// ```
